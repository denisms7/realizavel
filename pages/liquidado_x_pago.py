...
================================================================
Página do app em Streamlit que cruza os relatórios "Relação da despesa
líquida liquidada" e "Relação da despesa líquida paga" (exportados em CSV a
partir dos PDFs oficiais) e aponta onde o valor liquidado diverge do valor
...
Estrutura de pastas esperada:
    realizavel/
      ...
      pages/liquidado_x_pago.py       <- este arquivo
