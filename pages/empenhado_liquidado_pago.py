...
==========================================================================
Página do app em Streamlit que cruza os três relatórios do ciclo da despesa
pública ("Relação da despesa líquida empenhada", "...liquidada" e "...paga",
...
Estrutura de pastas esperada:
    realizavel/
      ...
      pages/empenhado_liquidado_pago.py       <- este arquivo
